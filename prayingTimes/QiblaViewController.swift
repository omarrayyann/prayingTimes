...
class QiblaViewController: UIViewController {
    ...
    @IBOutlet weak var turnOnError: UILabel!
    @IBOutlet weak var turnLocationButton: UIButton!
    @IBOutlet weak var turnOnLocationButtonLabel: UILabel!
    ...
    override func viewDidLoad() {
        ...
        turnOnLocationButtonLabel.attributedText = NSAttributedString(string: "turn on location services", attributes:
        ...
        if CLLocationManager.authorizationStatus() == .denied {
            ...
            turnOnError.isHidden = false
            turnLocationButton.isHidden = true
            turnOnLocationButtonLabel.isHidden = true

        }
        if CLLocationManager.authorizationStatus() == .notDetermined {
            arrowImage.isHidden = true
            circleImage.isHidden = true
            turnOnError.isHidden = true
            turnLocationButton.isHidden = false
            turnOnLocationButtonLabel.isHidden = false
